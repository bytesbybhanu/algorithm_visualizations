...
import { dijkstra, getNodesInShortestPathOrder, dfs, bfs, astar } from "./Algorithm";
        ...
        return (
            <>
                ...
                <AppNavbar
                    ...
                    handleReset={this.resetGrid} // Added reset function to the navbar
...
// updating the grid, setting up the walls
